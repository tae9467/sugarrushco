...
A full-stack e-commerce shop for handmade lip gloss, slime, body butter, and perfume. Designed and built from scratch: custom storefront, secure checkout, and a complete admin dashboard for running the business day to day.
