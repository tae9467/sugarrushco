...
window.SHOP_DATA = {
  ...
  products: [ /* populated from server on load — see app.jsx */
    ...
    { id: "gloss-cherry", cat: "lipgloss", name: "Cherry Cola Gloss", price: 8, stock: 10,
    ...
    { id: "gloss-cotton", cat: "lipgloss", name: "Cotton Candy Cloud Gloss", price: 9, stock: 10,
    ...
    { id: "candle-bigtop", cat: "candles", name: "Big Top Birthday Candle", price: 14, stock: 8,
    ...
    { id: "candle-cherries", cat: "candles", name: "Cherries Jubilee Candle", price: 14, stock: 8,
    ...
    { id: "candle-carnival", cat: "candles", name: "Cotton Candy Carnival Candle", price: 12, stock: 8,
    ...
    { id: "squish-shortcake", cat: "squishies", name: "Strawberry Shortcake Squishy", price: 6, stock: 15,
    ...
    { id: "squish-cherry", cat: "squishies", name: "Cherry Cupcake Squishy", price: 7, stock: 15,
    ...
    { id: "squish-bear", cat: "squishies", name: "Circus Bear Squishy", price: 8, stock: 15,
    ...
    { id: "butter-strawberry", cat: "body-butter", name: "Whipped Strawberry Body Butter", price: 12, stock: 10,
    ...
    { id: "butter-vanilla", cat: "body-butter", name: "Vanilla Buttercream Body Butter", price: 12, stock: 10,
    ...
    { id: "perfume-cotton", cat: "perfume", name: "Cotton Candy Mist", price: 16, stock: 8,
    ...
    { id: "perfume-cherry", cat: "perfume", name: "Cherry Bow Eau de Parfum", price: 18, stock: 8,
